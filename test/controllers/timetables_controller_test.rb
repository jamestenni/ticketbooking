...
class TimetablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create timetable" do
    assert_difference('Timetable.count') do
      post timetables_url, params: { timetable: { datetime_start: @timetable.datetime_start, movie_id: @timetable.movie_id, theater_id: @timetable.theater_id } }
    end
  ...
  test "should update timetable" do
    patch timetable_url(@timetable), params: { timetable: { datetime_start: @timetable.datetime_start, movie_id: @timetable.movie_id, theater_id: @timetable.theater_id } }
