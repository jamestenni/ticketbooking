class ChairsController < ApplicationController
  ...
  private
    ...
    def chair_params
      params.require(:chair).permit(:row, :column, :chair_type, :theater_id)
    end

    # This function will return active relation of chairs sorted by [theater_number, row, column]
    def get_chairs
      return Chair.joins(:theater).order(:number, :row, :column)
    end
end
